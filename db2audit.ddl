...
CREATE TABLE AUDIT_NEW ( TIMESTAMP CHAR(26 OCTETS),
                     ...
                     TENANTNAME VARCHAR(128 OCTETS)) ORGANIZE BY ROW; 

--
-- CHECKING CATEGORY
--

CREATE TABLE CHECKING_NEW ( TIMESTAMP CHAR(26 OCTETS),
                        CATEGORY CHAR(8 OCTETS),
                        EVENT VARCHAR(32 OCTETS),
                        CORRELATOR INTEGER,
                        STATUS INTEGER,
...
CREATE TABLE OBJMAINT_NEW ( TIMESTAMP CHAR(26 OCTETS),
                        CATEGORY CHAR(8 OCTETS),
                        EVENT VARCHAR(32 OCTETS),
                        CORRELATOR INTEGER,
                        STATUS INTEGER,
...
CREATE TABLE SECMAINT_NEW ( TIMESTAMP CHAR(26 OCTETS),
                        CATEGORY CHAR(8 OCTETS),
                        EVENT VARCHAR(32 OCTETS),
                        CORRELATOR INTEGER,
                        STATUS INTEGER,
...
CREATE TABLE SYSADMIN_NEW ( TIMESTAMP CHAR(26 OCTETS),
                        CATEGORY CHAR(8 OCTETS),
                        EVENT VARCHAR(32 OCTETS),
                        CORRELATOR INTEGER,
                        STATUS INTEGER,
...
CREATE TABLE VALIDATE_NEW ( TIMESTAMP CHAR(26 OCTETS),
                        CATEGORY CHAR(8 OCTETS),
                        EVENT VARCHAR(32 OCTETS),
                        CORRELATOR INTEGER,
                        STATUS INTEGER,
...
CREATE TABLE CONTEXT_NEW ( TIMESTAMP CHAR(26 OCTETS),
                       CATEGORY CHAR(8 OCTETS),
                       EVENT VARCHAR(32 OCTETS),
                       CORRELATOR INTEGER,
                       DATABASE CHAR(8 OCTETS),
...
CREATE TABLE EXECUTE_NEW ( TIMESTAMP CHAR(26 OCTETS),
                       CATEGORY CHAR(8 OCTETS),
                       EVENT VARCHAR(32 OCTETS),
                       CORRELATOR INTEGER,
                       STATUS INTEGER,

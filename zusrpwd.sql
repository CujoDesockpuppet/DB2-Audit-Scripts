...
CREATE UNIQUE INDEX "SAPCAP  "."ZUSRPWD~0" ON "SAPCAP  "."ZUSRPWD" 
		("BNAME" ASC)
		PCTFREE 0 
		COMPRESS YES 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
-- DDL Statements for Primary Key on Table "SAPCAP  "."ZUSRPWD"

ALTER TABLE "SAPCAP  "."ZUSRPWD" 
	ADD CONSTRAINT "ZUSRPWD~0" PRIMARY KEY
		("BNAME")
	ENFORCED;
